...
// force user to submit form only when filled in
...
function handleFormSubmit(event) {  // handles form submit withtout any jquery
  ...
  // store end of survey time
  var surveyStart = document.getElementById("survey-time").value;
  var elapsedTime = Math.round(performance.now()) / 1000.0 - surveyStart;
  document.getElementById("survey-time").value = elapsedTime;
  ...
  // remove initial aside
  document.querySelector("aside.intro").style.display = "none";
